...
export const HeroSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-b from-secondary to-background py-20 md:py-32 dark:from-background dark:to-background dark:bg-grid-white/[0.2]" aria-labelledby="hero-heading">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-4">
            <h1 id="hero-heading" className="text-4xl md:text-6xl font-bold text-foreground mb-6 animate-fadeIn">
              Discover Your Next
              <span className="text-primary dark:text-primary/90"> Literary Adventure</span>
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground mb-8 animate-fadeIn max-w-2xl mx-auto" style={{ animationDelay: "0.2s" }}>
              Welcome to your personal reading sanctuary. From timeless classics to contemporary gems,
              find stories that speak to your soul and spark your imagination.
            </p>
          </div>
